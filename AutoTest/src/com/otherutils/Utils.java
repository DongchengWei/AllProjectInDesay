...
public class Utils extends UiAutomatorTestCase {
	 ...
	 * @Date 2017-06-03
	 */
	public static String msToFormateTime(long msTime) {
		SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");//初始化Formatter的转换格式。
		return formatter.format(msTime);
	}
...
//			String saveTimeStr = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(date);
			...
			//TODO
			//rootLogPathStr = "/sdcard/AutoTest/", saveTimeStr时间命名的文件夹
			String savePathStr = pathStr;//拼接保存目录
			logPrint("saveLogPathStr:" + savePathStr);
...
//    	logPrint("Delete pass capture:" + pPath);
